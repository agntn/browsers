...
describe("normalizeMainArgs", () => {
  ...
  it("preserves known subcommands", () => {
    expect(normalizeMainArgs(["scrape", "https://example.com"])).toEqual(["scrape", "https://example.com"])
    expect(normalizeMainArgs(["screenshot", "https://example.com"])).toEqual(["screenshot", "https://example.com"])
    expect(normalizeMainArgs(["crawl"])).toEqual(["crawl"])
    expect(normalizeMainArgs(["pdf", "https://example.com"])).toEqual(["pdf", "https://example.com"])
